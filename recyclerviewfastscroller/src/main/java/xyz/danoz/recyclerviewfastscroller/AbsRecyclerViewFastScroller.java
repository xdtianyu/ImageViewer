...
public abstract class AbsRecyclerViewFastScroller extends FrameLayout implements RecyclerViewScroller {
    ...
    */
            ...
            mOnScrollListener = new OnScrollListener() {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    if (scrollProgressCalculator != null) {
                        ...
                        scrollProgress = scrollProgressCalculator.calculateScrollProgress(recyclerView, dx, dy);
                    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (false) {
            float scrollProgress = getScrollProgressCalculator().calculateScrollProgress(mRecyclerView, 0, 0);
            moveHandleToPosition(scrollProgress);
        }
    }
